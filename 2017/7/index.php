...
<html>
	...
	<body>
		<h1>Lee Smith - Advent of Code 2017 - Day 2</h1>

		<?php 
		$homeLoc = '/home/leejsmith91/advent';
		$level = 2;
		echo display_folders('<li class="{file_class}"><a href="{file_loc}">{file_name}</a>{file_sublist}</li>', '/home/leejsmith91/advent/2017/2', $level, '/2017/2/'); ?>
		<?php
		$text = '';
